...
TEZI_UBOOT_BINARY_EMMC:mx8-generic-bsp ??= "${UBOOT_BINARY_TEZI_EMMC}"
TEZI_UBOOT_BINARY_RAWNAND ??= "${UBOOT_BINARY}"
TEZI_UBOOT_BINARY_RECOVERY ??= "${UBOOT_BINARY}"
TEZI_UBOOT_BINARY_RECOVERY:am62xx ??= "tiboot3-am62x-gp-evm.bin-dfu tiboot3-am62x-hs-fs-evm.bin-dfu u-boot.img-recoverytezi"
