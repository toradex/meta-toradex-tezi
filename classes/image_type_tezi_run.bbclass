...
EMMCDEV:toradex-smarc-imx8mp = "emmc"
EMMCDEVBOOT0 = "mmcblk0boot0"
EMMCDEVBOOT0:verdin-imx8mp = "emmc-boot0"
EMMCDEVBOOT0:toradex-smarc-imx8mp = "emmc-boot0"
...
TEZI_UBOOT_BINARY_EMMC:mx9-generic-bsp ??= "${UBOOT_BINARY_TEZI_EMMC}-sd"
TEZI_UBOOT_BINARY_EMMC:apalis-imx6 ??= "${UBOOT_BINARY}-sd"
TEZI_UBOOT_BINARY_EMMC:colibri-imx6 ??= "${UBOOT_BINARY}-sd"
TEZI_UBOOT_BINARY_EMMC:k3 ??= "${UBOOT_BINARY}-sd"
...
TEZI_UBOOT_BINARY_RECOVERY:mx9-generic-bsp ??= "${UBOOT_BINARY_TEZI_EMMC}-recoverytezi"
TEZI_UBOOT_BINARY_RECOVERY:am62xx ??= "tiboot3-am62x-gp-verdin.bin tiboot3-am62x-hs-fs-verdin.bin u-boot.img-recoverytezi"
TEZI_UBOOT_BINARY_RECOVERY:am62pxx ??= "tiboot3-am62px-hs-fs-verdin.bin u-boot.img-recoverytezi"
TEZI_UBOOT_BINARY_RECOVERY:j784s4 ??= "tiboot3-am69-hs-fs-aquila.bin u-boot.img-recoverytezi"
...
do_image_tezirunimg[depends] += "virtual/bootloader:do_deploy u-boot-distro-boot:do_deploy linux-yocto-fitimage:do_deploy tezi-run-metadata:do_deploy uuu-bin:do_deploy"
do_image_tezirunimg[vardepsexclude] = "DISTRO_VERSION TDX_VER_ID DATE"
