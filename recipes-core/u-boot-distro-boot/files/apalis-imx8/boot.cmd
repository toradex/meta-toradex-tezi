setenv bootargs 'console=ttyLP1,115200 earlycon=lpuart32,0x5a070000,115200,115200 video=imxdpufb5:off video=imxdpufb6:off video=imxdpufb7:off rootfstype=squashfs root=/dev/ram autoinstall ${teziargs}' 
