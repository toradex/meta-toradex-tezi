setenv bootargs igb_mac=${ethaddr} console=ttyS0,115200 quiet video=HDMI-A-1:640x480-16@60D video=LVDS-1:640x480-16@60D rootfstype=@@TEZI_INITRD_IMAGE@@ root=/dev/ram autoinstall ${teziargs}
